...
const Register = () => {
  ...
  //função assincrona com um evento de click no botão cadastrar
  async function handleForm(e) {
    ...
    //apos o preenchimento do formulario ira aparecer uma msg de alert, limpar os campos e ir para a page de login
